...
<p align = "justify">Demonstrate the stffiness matrix about frame element:</p>

<ol>
<li>Comprimento do elemente de 3 m \((L=3 m)\);</li>
<li>Ângulo em relação ao eixo \(x\) de 30°  \((sin = 0.5, \; cos = 0.8660254038)\);</li>
<li>Seção transversal retangular de 0.1 m por 0.3 m \( (A = 0.1 \cdot 0.3, I  = ???) \)</li>
<li>Propriedade do material: $ E =  210\cdot 10^6 \; kPa$, $ G = 77\cdot 10^6 \; kPa$, $\nu = 0.3$, $ \alpha = 1 \cdot 10^{-5} \; \degree C^{-1} $ and $ \rho = 78,500 \; kg \cdot m^{-3} $ </br>
<li>(e) Condição de engastamento nó inicial engastado e final engastado</br>
</ol>
